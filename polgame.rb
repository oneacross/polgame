...
speakers_db = [
  ...
  {"wapo_api" => 7,"first_name" => "Jim","last_name"=>"Lehrer","party"=>"","url"=>"http://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Paul_Ryan_official_portrait.jpg/220px-Paul_Ryan_official_portrait.jpg","width"=>170,"height"=>242},
  ...
  {"wapo_api" => 4,"first_name" => "Paul","last_name"=>"Ryan","party"=>"Republican","url"=>"http://www.pbs.org/newshour/aboutus/images/photo_bio_lehrer.jpg","width"=>170,"height"=>242}
]
